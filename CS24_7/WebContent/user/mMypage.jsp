		...
		<div class="container">
			<div class="col-md-6 col-sm-8 col-md-offset-3 col-sm-offset-2">
				...
				<form name="form" method="POST"
					action="<c:url value='/user/master/mypage'> 
					...
					<h4>My Store</h4>
					<div class="form-group">
						<label>licenseNo&nbsp;&nbsp;:&nbsp;&nbsp;${user.licenseNo}</label>
					</div>

					<div class="form-group">
						<label>Location&nbsp;&nbsp;:&nbsp;&nbsp;${store.location}</label>
					</div>
					<div class="form-group">
						<label>Store name&nbsp;&nbsp;:&nbsp;&nbsp;${store.sname}</label>
					</div>
					<div class="form-group">
						<label>store phone
							number&nbsp;&nbsp;:&nbsp;&nbsp;${store.phone}</label>
					</div>

					<div class="form-group text-right">

						<a
							href="<c:url value='/user/master/update/form'>
                       <c:param name='id' value='${user.id}'/>
                    </c:url>">수정</a>
						&nbsp; <a
							href="<c:url value='/user/master/delete'>
                     <c:param name='id' value='${user.id}'/>
                    </c:url>"
