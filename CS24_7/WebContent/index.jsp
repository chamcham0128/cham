...
<body>
	...
	<section class="main-banner" style="background: #242c36 no-repeat">
		<div class="container">
			<div class="caption">
				<h2>Where is your yummy?</h2>
				<form name="form" method="POST"
					...
					<fieldset>
						...
						<div class="col-md-3 col-sm-3 no-pad">
							<text class="form-control border-right">
						</div>
						<div class="col-md-3 col-sm-3 no-pad">
							<select class="selectpicker" name="catno">
